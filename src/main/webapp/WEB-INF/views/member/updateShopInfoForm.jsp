...
<body style="font-family: 'Gugi';">
  ...
  <%-- 	<!-- 수정 시 넘길 값 -->
  	<input type="hidden" name="smCate" value="${ sm.get("menuCate") }">
  	<input type="hidden" name="smNo" value="${ sm.get("shopNo") }">
  	<input type="hidden" name="smsCate" value="${ sms.get("menuCate") }">
  	<input type="hidden" name="smsNo" value="${ sms.get("shopNo") }">
  	<input type="hidden" name="smbCate" value="${ smb.get("menuCate") }">
  	<input type="hidden" name="smbNo" value="${ smb.get("shopNo") }"> --%>
