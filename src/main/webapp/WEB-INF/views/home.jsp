...
<style>
	...
	p,h4{font-family: 'Gugi';}
	 ...
	 .img{height:70vh;background-size: cover;margin:0;font-family:'Gugi';
	 	background-image: linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) ),url("resources/images/mainpage/main.png");}
	...
	.list_wrap .item .image {width:120%; height:160px;  background: url("resources/images/mainpage/main.png");  background-position:50% 50%; background-size:cover; }
...
=======
	<c:import url="WEB-INF/views/common/menubar.jsp"/>	
	  ...
	  <div class="img">
        <div class="content">
            ...
            <h2>밥먹고가조!</h2>
			<img src="resources/images/mainpage/위치.png"  width="50px" height="50px"><br>
	...
	<br><br>
  	...
  	<span class="dishtype" id="dishtype1" >
		<img src="resources/images/mainpage/한식.png">
	</span>
	
	<span class="dishtype" id="dishtype2">
		<img src="resources/images/mainpage/중식.png">
	</span>
	
	<span class="dishtype" id="dishtype3">
		<img src="resources/images/mainpage/양식.png">
	</span>
	
	<span class="dishtype" id="dishtype4">
		<img src="resources/images/mainpage/일식.png">
	</span>  
	...
	<div class="list_wrap">
		<ul>
			<li class="item item1"> 
				<div class="image"></div>			<!-- 이부분은 style부분에 이미지 추가 -->
				<div class="cont">
	...
	<div class="carousel">
  <div><img src="resources/images/mainpage/양식.png" width="200px">item 1</div>
  <div><img src="resources/images/mainpage/한식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/일식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/양식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/한식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/중식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/일식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/양식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/양식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/중식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/양식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/일식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/양식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/중식.png" width="200px">item 2</div>
  <div><img src="resources/images/mainpage/양식.png"  width="200px">item 3</div>
  <div><img src="resources/images/mainpage/한식.png" width="200px">item 2</div>
...
$('.carousel').slick({slidesToShow:5, slidesToScroll:5, dots:true});	
	...
	<br><br>
>>>>>>> 53d82e20588d1769533add361e500671680982da
