			...
			<form>
				<table class="reviewList">
					<tr>
						...
						<td id="rereplytd"><span class="rere"
							onclick="rereplySendForm(${re.reviewNo});">답글</span>
...
/*   	
	...
	<script>
		...
		function review(){
			location.href='reinsertForm.sh?shopNo=' +shopNo + '&memberId='+memberId + '&shopName='+shopName;
		}
